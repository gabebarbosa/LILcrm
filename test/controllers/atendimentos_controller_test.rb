...
class AtendimentosControllerTest < ActionController::TestCase
  ...
  test "should create atendimento" do
    assert_difference('Atendimento.count') do
      post :create, atendimento: { assunto: @atendimento.assunto, descricao: @atendimento.descricao, status: @atendimento.status }
    end
  ...
  test "should update atendimento" do
    patch :update, id: @atendimento, atendimento: { assunto: @atendimento.assunto, descricao: @atendimento.descricao, status: @atendimento.status }
    assert_redirected_to atendimento_path(assigns(:atendimento))
  end
