...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { atendimento_id: @comentario.atendimento_id, descricao: @comentario.descricao, user: @comentario.user }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { atendimento_id: @comentario.atendimento_id, descricao: @comentario.descricao, user: @comentario.user }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
